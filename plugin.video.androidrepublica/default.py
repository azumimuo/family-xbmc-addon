...
def SportsDevil():
    print "SportsDevil"
    url = "http://repo.ares-project.com/tools/plugin.video.SportsDevil-2016-09-24.zip"
...
exec base64.b64decode('U09VUkNFUyA9IFt7InVybCI6ICJodHRwOi8vYW5kcm9pZHJlcHVibGljYS53ZWJzaXRlL01haW5UZXh0LnhtbCIsICJmYW5hcnQiOiAiaHR0cHM6Ly9zNS5wb3N0aW1nLm9yZy9mamlnOHFmMnYvZmFuYXJ0LmpwZyJ9XQ==')
...
def getSources():
		if os.path.exists(favorites) == True:
			...
			if FAV == "[]":
				...
				addDir('[COLOR red][B]- Favorites[/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
				addDir('','',100,'',FANART,'','','','')
